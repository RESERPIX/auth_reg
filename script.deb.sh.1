...
main ()
{
  ...
  gpg_key_url="https://packagecloud.io/golang-migrate/migrate/gpgkey"
  apt_config_url="https://packagecloud.io/install/repositories/golang-migrate/migrate/config_file.list?os=${os}&dist=${dist}&source=script"

  apt_source_path="/etc/apt/sources.list.d/golang-migrate_migrate.list"
  apt_keyrings_dir="/etc/apt/keyrings"
  if [ ! -d "$apt_keyrings_dir" ]; then
    install -d -m 0755 "$apt_keyrings_dir"
  fi
  gpg_keyring_path="$apt_keyrings_dir/golang-migrate_migrate-archive-keyring.gpg"
    gpg_key_path_old="/etc/apt/trusted.gpg.d/golang-migrate_migrate.gpg"
